...
function MainWindow(props: MainWindowProps) {
  ...
  switch (props.view) {
    case AppView.welcome:
      ...
      break;
    case AppView.home:
      page = <Home theme={props.theme} notes={notes} dateFormat={appSettings.dateFormat} timeFormat={appSettings.timeFormat} noteFont={appSettings.noteFont} handleDeleteNoteButton={handleDeleteNote} handleNoteSave={handleSaveNote} />
      break;
    default:
      page = <Home theme={props.theme} notes={notes} dateFormat={appSettings.dateFormat} timeFormat={appSettings.timeFormat} noteFont={appSettings.noteFont} handleDeleteNoteButton={handleDeleteNote} handleNoteSave={handleSaveNote} />
  }
